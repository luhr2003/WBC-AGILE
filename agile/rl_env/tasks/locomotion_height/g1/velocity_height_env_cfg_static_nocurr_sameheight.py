...
class ActionsCfg:
    ...
    random_upper_body_pos = mdp.RandomActionCfg(
        ...
        preserve_order=True,
        no_random_when_walking=True,  # Variant 5: Static during walking
        command_name="base_velocity",
        use_curriculum_sampling=False,  # Variant 5: No curriculum
    )
...
@configclass
class G1LowerVelocityHeightEnvCfgV5(ManagerBasedRLEnvCfg):
...
@configclass
class G1VelocityHeightRecurrentStudentEnvCfgV5(G1LowerVelocityHeightEnvCfgV5):
...
@configclass
class G1VelocityHeightHistoryStudentEnvCfgV5(G1VelocityHeightRecurrentStudentEnvCfgV5):
    """Configuration for the student distillation locomotion velocity-tracking environment."""
