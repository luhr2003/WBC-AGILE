...
@configclass
class G1LowerVelocityHeightFlatLinearNoCurrEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the G1 velocity tracking environment on flat terrain with linear velocity profile, no curriculum."""
