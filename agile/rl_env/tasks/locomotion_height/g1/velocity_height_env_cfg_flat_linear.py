...
@configclass
class G1LowerVelocityHeightFlatLinearEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the G1 velocity tracking environment on flat terrain with linear velocity profile."""
